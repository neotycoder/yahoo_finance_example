...
# This example adds an __init__ script so that this version of the script will be executed if called directly, or be imported
# like a module for use in other script.
...
# This is the equivalent of calling main(), with one caveat, this will only execute if
# the script is called directly. This will allow the script to be imported like a module
